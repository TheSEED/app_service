...
function AppService(url, auth, auth_cb) {
    ...
    this.query_app_summary = function (_callback, _errorCallback) {
    return json_call_ajax("AppService.query_app_summary",
        [], 1, _callback, _errorCallback);
};

    this.query_app_summary_async = function (_callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("AppService.query_app_summary", [], 1, _callback, _error_callback);
    };
    ...
    this.enumerate_tasks_filtered = function (offset, count, simple_filter, _callback, _errorCallback) {
    return json_call_ajax("AppService.enumerate_tasks_filtered",
        [offset, count, simple_filter], 2, _callback, _errorCallback);
};

    this.enumerate_tasks_filtered_async = function (offset, count, simple_filter, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("AppService.enumerate_tasks_filtered", [offset, count, simple_filter], 2, _callback, _error_callback);
    };
    ...
    this.kill_tasks = function (ids, _callback, _errorCallback) {
    return json_call_ajax("AppService.kill_tasks",
        [ids], 1, _callback, _errorCallback);
};

    this.kill_tasks_async = function (ids, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("AppService.kill_tasks", [ids], 1, _callback, _error_callback);
    };
